...
const accessToken = "pk.eyJ1Ijoic2pydWdncyIsImEiOiJjbHBycTNmenYwMXh3MnBzZjN1aGgwdDZxIn0.wjDhU4MDyDscnCWlkZIfCg";
let map;
...
const addMarkersToMap = (json, clickHandler) => { json.features.forEach((feature) => { addMarker(feature, 'poi', clickHandler); });}
