...
export const loadMarkers = () => {
    ...
    // convert data go GeoJSON format
...
export const flyTo = (center = [0, 0]) => map.flyTo({ center: center });
export const setZoom = (val = 0) => map.setZoom(val);
export const setPitchAndBearing = (pitch = 0, bearing = 0) => {
    map.setPitch(pitch);
    map.setBearing(bearing);
}

export const addMarker = (coordinates, title, description, className) => {
