...
export const triangle = (ctx, {x1: x1, y1: y1, x2: x2, y2: y2, x3: x3, y3: y3, lineWidth: lineWidth = 0, fillStyle: fillStyle = "black", strokeStyle: strokeStyle = "black" }) => {
    ctx.save();
    ctx.fillStyle=fillStyle;
    ctx.beginPath();
    ctx.moveTo(x1,y1);
...
export const randomTriangle = ctx => triangle(ctx, {
    
        x1:          getRandom(-10, ctx.canvas.width + 10),
        y1:          getRandom(-10, ctx.canvas.height + 10),
        x2:          getRandom(-10, ctx.canvas.width + 10),
        y2:          getRandom(-10, ctx.canvas.height + 10),
        x3:          getRandom(-10, ctx.canvas.width + 10),
        y3:          getRandom(-10, ctx.canvas.height + 10),
        lineWidth:   getRandom(2,   30),
        fillStyle:   getRandomColor(),
    }
);
